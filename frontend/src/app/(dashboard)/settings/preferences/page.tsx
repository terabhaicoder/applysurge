...
import { Save, Plus, X, Loader2, Target, MapPin, DollarSign, Sparkles, ArrowLeft } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-1">Define what jobs the agent should look for</p>
          </div>
        </div>
        <button
          onClick={handleSave}
