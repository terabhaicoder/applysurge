...
import { Check, AlertCircle, Loader2, Trash2, ArrowLeft, Shield, Link2, Eye, EyeOff, ChevronDown, Cookie } from 'lucide-react';
  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground tracking-tight">Platform Connections</h1>
          <p className="text-muted-foreground text-sm mt-1">Connect your job platform accounts for automated applications</p>
        </div>
      </div>
